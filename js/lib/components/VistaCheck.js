        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              vistaClient = new _index.VistaClient(_this.props.public_key, _this.props.hostname);
              _context.next = 4;
              return vistaClient.users.check(_this.props.user_id, _this.props.action, _this.props.resource_type, _this.props.resource_id, _this.props.environment)["catch"](function (err) {
