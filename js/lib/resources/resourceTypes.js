...
var ResourceTypes = /*#__PURE__*/function (_ApiResource) {
  ...
  function ResourceTypes() {
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                return _context.abrupt("return", _this.dispatch('/v1/resource_types', _apiResource.HTTP_METHODS.GET, {
    ...
    _defineProperty(_assertThisInitialized(_this), "create", /*#__PURE__*/function () {
      var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(name, relationships, attributes, actions, environment) {
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                return _context2.abrupt("return", _this.dispatch('/v1/resource_types', _apiResource.HTTP_METHODS.POST, {
                  name: name,
