...
var Admin = /*#__PURE__*/function (_ApiResource) {
  ...
  function Admin() {
    ...
    _defineProperty(_assertThisInitialized(_this), "createEnvironment", /*#__PURE__*/function () {
      var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(environment) {
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                return _context.abrupt("return", _this.dispatch('/v1/environments', _apiResource.HTTP_METHODS.POST, {
