...
class VistaGrant extends React.Component {
    static contextType = VistaContext;
    static defaultProps = {
        styles: {},
    }
    ...
    grant = async (userId, roleId) => {
        ...
        const success = await this.props.grantRole(grantRequest).catch((err) => console.log(err));
...
const StyledVistaGrant = withStyles(styles)(VistaGrant);

export { VistaCheck, VistaGrant, StyledVistaGrant };
