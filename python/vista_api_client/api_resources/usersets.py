...
class Usersets(ApiResource):
    ...
    def create(self, userset_id, org_id, parent_usersets=[]):
    ...
    def grant_action(self, user_id, action, resource_id, resource_type, attribute=''):
        return self.grants.grant(user_id, 'USERSET', action, 'ACTION', resource_id, resource_type, attribute)

    def revoke_action(self, user_id, action, resource_id, resource_type, attribute=''):
        return self.grants.revoke(user_id, 'USERSET', action, 'ACTION', resource_id, resource_type, attribute)

    def grant_role(self, user_id, role_id, resource_id, resource_type):
        return self.grants.grant(user_id, 'USERSET', role_id, 'ROLE', resource_id, resource_type, '')

    def revoke_role(self, user_id, role_id, resource_id, resource_type):
        return self.grants.revoke(user_id, 'USERSET', role_id, 'ROLE', resource_id, resource_type, '')
